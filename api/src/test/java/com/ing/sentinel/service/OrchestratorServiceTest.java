...
class OrchestratorServiceTest {
    ...
    void testAccessRootAgent() {
        assertNotNull(com.ing.sentinel.agents.SentinelOrchestrator.ROOT_AGENT, 
    ...
    void testGetAgentName() {
        String agentName = com.ing.sentinel.agents.SentinelOrchestrator.ROOT_AGENT.name();
        ...
        assertDoesNotThrow(() -> {
            com.google.adk.runner.InMemoryRunner runner = 
                new com.google.adk.runner.InMemoryRunner(
                    com.ing.sentinel.agents.SentinelOrchestrator.ROOT_AGENT);
