    ...
    public static BaseAgent initAgent() {
        ...
        try {
            ...
            FunctionTool amountDeviationTool = FunctionTool.create(
                    com.ing.sentinel.tools.behavioral.AmountDeviationSignal.class, "analyzeAmountDeviation");
            FunctionTool timeDeviationTool = FunctionTool.create(
                    com.ing.sentinel.tools.behavioral.TimeDeviationSignal.class, "analyzeTimeDeviation");
            FunctionTool geoDeviationTool = FunctionTool.create(
                    com.ing.sentinel.tools.behavioral.GeoDeviationSignal.class, "analyzeGeoDeviation");
            FunctionTool newDeviceTool = FunctionTool.create(
                    com.ing.sentinel.tools.behavioral.NewDeviceSignal.class, "analyzeNewDevice");
            FunctionTool newIpRangeTool = FunctionTool.create(
                    com.ing.sentinel.tools.behavioral.NewIpRangeSignal.class, "analyzeNewIpRange");
