    ...
    public static BaseAgent initAgent() {
        ...
        try {
            ...
            FunctionTool flagMergerTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.evidence.FlagMergerTool.class, "mergeFlags");
            FunctionTool summaryComposerTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.evidence.SummaryComposerTool.class, "composeSummary");
            FunctionTool evidenceBuilderTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.evidence.EvidenceBuilderTool.class, "buildEvidenceBundle");
