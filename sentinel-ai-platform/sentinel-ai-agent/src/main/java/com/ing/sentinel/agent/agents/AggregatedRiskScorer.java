    ...
    public static BaseAgent initAgent() {
        ...
        try {
            ...
            FunctionTool normalizerTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.aggregator.ScoreNormalizer.class, "normalizeScore");
            FunctionTool blenderTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.aggregator.WeightedScoreBlender.class, "blendWeightedScores");
            FunctionTool boosterTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.aggregator.RiskBooster.class, "applyRiskBoost");
            FunctionTool calibratorTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.aggregator.ScoreCalibrator.class, "calibrateScore");
            FunctionTool classifierTool = FunctionTool.create(
                    com.ing.sentinel.agent.tools.aggregator.SeverityClassifier.class, "classifySeverity");
